                    ...
                    if (!useLegacyDreamcastBuilder)
                    {
                        ...
                        if (std::filesystem::exists(scriptPath))
                        {
                            ...
                            if (mc.is_open())
                            {
                                ...
                                mc << "static const char* kSceneAnimDisk[MAX_MESHES] = {";
                                ...
                                mc << "};\n";
                                mc << "static const uint8_t kSceneRuntimeTest[MAX_MESHES] = {";
                                for (size_t si = 0; si < exportStatics.size() && si < 64; ++si)
                                {
                                    mc << (exportStatics[si].runtimeTest ? "1" : "0");
                                    if (si + 1 < exportStatics.size() && si + 1 < 64) mc << ",";
                                }
                                mc << "};\n";
